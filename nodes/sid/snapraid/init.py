def main():
    ...
    X(f"sudo ln -s {NODE}/snapraid/disk-snapper.conf /etc/snapper/config-templates/")
    ...
    X("sudo ln -s {NODE}/snapraid/snapraid-btrfs-runner.service /etc/systemd/system/")
    X("sudo ln -s {NODE}/snapraid/snapraid-btrfs-runner.timer /etc/systemd/system/")
